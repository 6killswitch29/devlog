...
export default function TagChips({
	...
	const chip = 'inline-flex items-baseline gap-1.5 rounded-full border px-2.5 py-0.5 text-[0.8125rem] hover:no-underline';
	...
	return (
		<div>
			<p className="mb-2 text-[0.6875rem] font-semibold tracking-[0.12em] text-fg-muted">TAGS</p>
